 ...
 * it again. The batch seed and the shared parameters are both here, so the manifest is a complete
 * recipe even if every video file is deleted.
 */
public record BatchManifest(String batchId, String template, int requested, int completed, int failed,
                            long seed, String createdAt, Map<String, Object> parameters,
